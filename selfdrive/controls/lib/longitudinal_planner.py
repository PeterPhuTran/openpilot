...
class LongitudinalPlanner:
  ...
  def update(self, sm, frogpilot_toggles):
    ...
    _, _, _, _, throttle_prob = self.parse_model(sm['modelV2'], frogpilot_toggles)
    ...
    self.mpc.update(sm['radarState'], v_cruise, sm['frogpilotPlan'].dangerFactor, sm['frogpilotPlan'].tFollow, accel_clip[0], accel_clip[1], personality=sm['selfdriveState'].personality)
